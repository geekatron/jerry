...
**SSOT:** `.context/rules/quality-enforcement.md` (H-13 threshold, H-16, dimension weights, criticality levels, strategy catalog) | `ADR-EPIC002-001` (strategy selection, score 4.30) | `ADR-EPIC002-002` (enforcement architecture) | `references/strategies/TEMPLATE-FORMAT.md` v1.1.0
