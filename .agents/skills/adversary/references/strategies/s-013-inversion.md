...
**SSOT:** `.context/rules/quality-enforcement.md` (H-13 threshold, dimension weights, criticality levels) | `ADR-EPIC002-001` (strategy selection, score 4.25) | `ADR-EPIC002-002` (enforcement architecture) | `references/strategies/TEMPLATE-FORMAT.md` v1.1.0
