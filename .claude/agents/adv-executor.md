...
enforcement:
  tier: medium
name: adv-executor
description: "Strategy Executor agent \u2014 loads and executes adversarial strategy\
  \ templates against deliverables, producing structured finding reports with severity\
