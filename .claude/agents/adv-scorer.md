...
enforcement:
  tier: medium
name: adv-scorer
description: "Quality Scorer agent \u2014 implements S-014 LLM-as-Judge rubric scoring\
  \ with the SSOT 6-dimension weighted composite, producing per-dimension scores,\
