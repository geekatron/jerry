...
guardrails:
  ...
  minimum_alternatives:
    ...
    on_insufficient:
      action: warn
      message: Divergent exploration should generate at least 3 alternatives. Continue
        generating.
      guidance:
...
name: nse-explorer
description: NASA Systems Engineering explorer agent implementing NPR 7123.1D Process
  17 (Decision Analysis) for divergent thinking, alternative generation, and trade
  space exploration
model: opus
identity:
