    ...
    review_type_enum:
      ...
      on_invalid:
        ...
        message_template: 'Invalid review type ''{input}''. Valid types: MCR, SRR,
          MDR, SDR, PDR, CDR, SIR, TRR, SAR, ORR, FRR'
      on_typo:
...
name: nse-reviewer
description: NASA Technical Review Gate agent implementing NPR 7123.1D Appendix G
  for SRR, PDR, CDR, FRR and other technical reviews with entrance/exit criteria
model: sonnet
identity:
