...
enforcement:
  tier: medium
  escalation_path: "Warn on missing criteria \u2192 Block completion without critique\
    \ artifact"
name: ps-critic
description: Quality evaluation agent for creator-critic-revision cycles with adversarial
  strategy integration (S-014 LLM-as-Judge primary) - critiques agent outputs using
  SSOT quality dimensions and provides improvement recommendations
model: sonnet
identity:
