...
enforcement:
  tier: medium
  escalation_path: "Warn on missing file \u2192 Block completion without investigation\
    \ report"
name: ps-investigator
description: Failure analysis and debugging agent using 5 Whys, Ishikawa, and FMEA
  with L0/L1/L2 output levels
model: sonnet
identity:
