...
enforcement:
  tier: medium
  escalation_path: "Warn on missing file \u2192 Block completion without synthesis\
    \ artifact"
name: ps-synthesizer
description: Meta-analysis agent for synthesizing patterns across multiple research
  outputs with adversarial quality strategies and L0/L1/L2 output levels
model: sonnet
identity:
