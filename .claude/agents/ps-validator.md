...
enforcement:
  tier: medium
  escalation_path: "Warn on missing file \u2192 Block completion without validation\
    \ report"
name: ps-validator
description: Constraint and design validation agent producing verification reports
