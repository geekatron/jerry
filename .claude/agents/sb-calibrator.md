...
enforcement:
  tier: medium
name: sb-calibrator
description: "Voice Fidelity Scorer \u2014 scores voice fidelity on a 0-1 scale across\
  \ the 5 voice traits, computes a composite voice fidelity score, and applies leniency\
  \ bias counteraction consistent with adv-scorer patterns"
model: sonnet
identity:
