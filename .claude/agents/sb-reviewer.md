...
enforcement:
  tier: medium
name: sb-reviewer
description: "Voice Compliance Reviewer \u2014 evaluates framework output text against\
  \ the 5 Authenticity Tests and boundary conditions, producing a pass/fail compliance\
  \ report with specific evidence and suggested fixes"
model: sonnet
identity:
