...
constitution:
  ...
  - 'P-010: Task Tracking Integrity (Medium - update state with parsing_method and
    validation_passed)'
...
enforcement:
  tier: medium
name: ts-parser
description: 'Strategy Pattern orchestrator for hybrid parsing: Python delegation
  for VTT, LLM fallback for others'
model: haiku
identity:
