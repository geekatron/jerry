...
enforcement:
  tier: medium
  escalation_path: "Warn on missing evidence \u2192 Block completion without 80% AC\
    \ verified"
name: wt-verifier
...
- id: WTI-002
  ...
  description: Work items MUST NOT transition to DONE without 80%+ acceptance criteria
    verified
- id: WTI-003
