...
> A controlled experiment reveals that LLMs are most dangerous not when they don't know — but when they're wrong about what they do know.
...
- [Methodology & Results](methodology.md) -- How we tested and what the numbers show
- [Architecture & Recommendations](architecture.md) -- Domain reliability tiers and builder guidance
- [Study Overview](index.md) -- Key metrics and quality gate scores
