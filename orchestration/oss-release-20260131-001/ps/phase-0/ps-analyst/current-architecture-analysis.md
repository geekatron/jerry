...
**Key Files:**
- `PROJ-008-transcript-skill/src/bootstrap.py` - Composition root
- `PROJ-008-transcript-skill/src/interface/cli/main.py` - CLI entry point
...
**Key Files:**
- `PROJ-008-transcript-skill/src/infrastructure/adapters/configuration/env_config_adapter.py`
- `PROJ-008-transcript-skill/src/session_management/infrastructure/adapters/os_environment_adapter.py`
...
| `adam.nowak` | In paths | In CLAUDE.md context only (OK) |
...
| `CLAUDE.md` | Contains worktracker paths to `adam.nowak` | Paths are in context, not code |
