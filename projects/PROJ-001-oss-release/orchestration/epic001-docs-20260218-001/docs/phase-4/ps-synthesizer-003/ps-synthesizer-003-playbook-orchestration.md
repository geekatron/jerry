...
- You need **orchestration** of 3 or more agents in a structured workflow — use the keyword `orchestration` in your request to trigger automatic invocation.
- You are designing a multi-step **pipeline** — any reference to a pipeline or pipeline coordination triggers this skill.
