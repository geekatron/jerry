...
|----|-------|--------|--------|----------|
| [BUG-004/TASK-001](./BUG-004--TASK-001-skip-pipeline-test-missing-datasets.md) | Restore missing transcript test data from source-repository | BUG-004 | pending | high |
