...
- EN-101: Claude Code Best Practices Research (to be created)
- EN-102: CLAUDE.md Optimization Research (to be created)
- EN-103: Claude Code Plugins Research (to be created)
- EN-104: Claude Code Skills Research (to be created)
- EN-105: Decomposition with Imports Research (to be created)
...
| Related | [DEC-002](./FEAT-002--DEC-002-orchestration-execution-decisions.md) | Orchestration decisions |
