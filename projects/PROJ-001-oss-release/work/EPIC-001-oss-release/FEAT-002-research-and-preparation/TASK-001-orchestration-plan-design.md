...
|-------------|------|------|
| ORCHESTRATION_PLAN.md | Markdown | projects/PROJ-001-oss-release/orchestration/ORCHESTRATION_PLAN.md |
| ORCHESTRATION.yaml | YAML | projects/PROJ-001-oss-release/orchestration/ORCHESTRATION.yaml |
| ORCHESTRATION_WORKTRACKER.md | Markdown | projects/PROJ-001-oss-release/orchestration/ORCHESTRATION_WORKTRACKER.md |
