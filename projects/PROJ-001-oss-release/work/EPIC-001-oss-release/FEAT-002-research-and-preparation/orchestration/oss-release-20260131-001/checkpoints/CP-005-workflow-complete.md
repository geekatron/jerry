...
| **Project ID** | PROJ-001-oss-release |
...
|                        OSS RELEASE                                        |
|                                                                           |
|   The PROJ-001 OSS Release Preparation workflow is COMPLETE.              |
...
|  ═══════════════════════════════════════════════════════════════════════  |
|                                                                           |
|  DECLARATION: The PROJ-001 OSS Release Preparation workflow has           |
...
*Checkpoint CP-005 created for PROJ-001-oss-release WORKFLOW COMPLETE.*
