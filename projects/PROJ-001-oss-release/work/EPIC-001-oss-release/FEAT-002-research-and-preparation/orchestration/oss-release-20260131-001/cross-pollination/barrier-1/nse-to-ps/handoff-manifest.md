...
|----------|------------------|-------------|-----------|
| Repository Structure | Monorepo, Multi-repo, Dual-repo, Fork-based | Dual-repo (private internal, jerry public) | Balance IP protection with community engagement |
...
*Document ID: PROJ-001-ORCH-B1-NSE2PS*
