...
| Field | Value |
|-------|-------|
| Review ID | PROJ-001-QG3-CRITIC-002 |
...
| Field | Value |
|-------|-------|
| **Document ID** | PROJ-001-QG3-CRITIC-002 |
| **Status** | COMPLETE |
| **Agent** | ps-critic |
...
*This adversarial review (v2) was produced by ps-critic agent for PROJ-001-oss-release QG-3 post-remediation assessment.*
