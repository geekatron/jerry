...
| Field | Value |
|-------|-------|
| Review ID | PROJ-001-QG3-CRITIC-001 |
...
| Field | Value |
|-------|-------|
| **Document ID** | PROJ-001-QG3-CRITIC-001 |
| **Status** | COMPLETE |
| **Agent** | ps-critic |
...
*This adversarial review was produced by ps-critic agent for PROJ-001-oss-release QG-3.*
