...
Apply the navigation table standard established in [FEAT-002:DEC-001](../FEAT-003--DEC-001-navigation-table-standard.md) to all worktracker-related files. This task MUST complete before other EN-202 tasks because navigation tables improve Claude's comprehension of the files being rewritten.
...
- **Grandparent:** [FEAT-002: CLAUDE.md Optimization](../FEAT-003-claude-md-optimization.md)

### Related Artifacts

| Type | Path | Description |
|------|------|-------------|
| Decision | [FEAT-002:DEC-001](../FEAT-003--DEC-001-navigation-table-standard.md) | Navigation table standard decision |
| Discovery | [FEAT-002:DISC-001](../FEAT-003--DISC-001-navigation-tables-for-llm-comprehension.md) | Research findings |
