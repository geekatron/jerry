# TASK-005: Optimize testing-standards.md and file-organization.md
...
Optimize `.context/rules/testing-standards.md` and `.context/rules/file-organization.md` by applying rule IDs from TASK-003, replacing verbose explanations with concise HARD/MEDIUM/SOFT enforcement language, removing cross-file redundancy, replacing inline constants with references to EN-701 SSOT, and tagging critical rules for L2 re-injection.

### Acceptance Criteria

- [ ] `testing-standards.md` optimized with rule IDs and tier vocabulary
- [ ] `file-organization.md` optimized with rule IDs and tier vocabulary
...
- Can run in parallel with: TASK-004, TASK-006, TASK-007, TASK-008, TASK-009
...
|-------------|------|------|
| Optimized `testing-standards.md` | Rule file | -- |
| Optimized `file-organization.md` | Rule file | -- |
...
| Date | Status | Notes |
|------|--------|-------|
| 2026-02-14 | Created | Initial creation. Parallelizable with TASK-004, TASK-006 through TASK-009 after TASK-003 completes. |
