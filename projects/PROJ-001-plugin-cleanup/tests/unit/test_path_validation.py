...
def normalize_path_to_project_centric(old_path: str, project_id: str = "PROJ-001-plugin-cleanup") -> str:
    """
    Convert an old docs/ path to project-centric format.

    Example:
        docs/research/PROJ-001-e-001.md
        -> projects/PROJ-001-plugin-cleanup/research/PROJ-001-e-001.md
    """
...
class TestValidProjectPaths:
    ...
    def test_valid_research_path(self):
    ...
    def test_valid_synthesis_path(self):
    ...
    def test_valid_analysis_path(self):
    ...
    def test_valid_decisions_path(self):
    ...
    def test_valid_reports_path(self):
    ...
    def test_category_extraction_research(self):
    ...
    def test_category_extraction_synthesis(self):
...
class TestEdgeCases:
    ...
    def test_category_extraction_with_nested_path(self):
...
class TestOldPathDetection:
    ...
    def test_old_docs_research_path_detected(self):
...
class TestPathNormalization:
    ...
    def test_normalize_research_path(self):
        """Should normalize docs/research/ to projects/.../research/."""
        old = "docs/research/PROJ-001-e-001-worktracker-proposal-extraction.md"
        expected = "projects/PROJ-001-plugin-cleanup/research/PROJ-001-e-001-worktracker-proposal-extraction.md"
        assert normalize_path_to_project_centric(old) == expected

    def test_normalize_synthesis_path(self):
        """Should normalize docs/synthesis/ to projects/.../synthesis/."""
        old = "docs/synthesis/PROJ-001-e-006-unified-architecture-canon.md"
        expected = "projects/PROJ-001-plugin-cleanup/synthesis/PROJ-001-e-006-unified-architecture-canon.md"
        assert normalize_path_to_project_centric(old) == expected

    def test_normalize_analysis_path(self):
        """Should normalize docs/analysis/ to projects/.../analysis/."""
        old = "docs/analysis/PROJ-001-e-007-implementation-gap-analysis.md"
        expected = "projects/PROJ-001-plugin-cleanup/analysis/PROJ-001-e-007-implementation-gap-analysis.md"
        assert normalize_path_to_project_centric(old) == expected

    def test_normalize_decisions_path(self):
        """Should normalize docs/decisions/ to projects/.../decisions/."""
        old = "docs/decisions/ADR-IMPL-001-unified-alignment.md"
        expected = "projects/PROJ-001-plugin-cleanup/decisions/ADR-IMPL-001-unified-alignment.md"
        assert normalize_path_to_project_centric(old) == expected

    def test_already_normalized_path_unchanged(self):
        """Already normalized paths should be returned unchanged."""
        path = "projects/PROJ-001-plugin-cleanup/research/file.md"
        assert normalize_path_to_project_centric(path) == path

    def test_normalize_with_custom_project_id(self):
...
class TestBoundaryConditions:
    ...
    def test_none_handling(self):
        """Functions should handle None gracefully via type hints."""
        # This test documents expected behavior - None would raise TypeError
        # which is acceptable as the type hints specify str
        pass

    def test_project_number_000(self):
