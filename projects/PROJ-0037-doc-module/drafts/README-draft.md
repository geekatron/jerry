...
| `/adversary` | Adversarial quality reviews and scoring | "Run adversarial review on this ADR" |
| `/eng-team` | Secure software engineering (OWASP, SDLC) | "Threat model the auth service" |
| `/red-team` | Offensive security methodology (ATT&CK) | "Recon the target application" |
| `/ast` | Markdown AST operations | "Validate entity frontmatter" |
| `/saucer-boy` | Session personality (McConkey voice) | "Give me a pep talk" |
| `/bootstrap` | First-time Jerry setup | "Bootstrap Jerry" |
| `/saucer-boy-framework-voice` | Framework output voice quality (internal) | Auto-loaded for output text |
...
Claude: I'll invoke the ps-analyst agent to investigate...
        ...
        Analysis saved to: projects/PROJ-007/analysis/test-failure-root-cause.md
```
...
- **58 Specialized Agents** across 13 skills — from research and analysis to security testing and infrastructure hardening. See [AGENTS.md](AGENTS.md) for the full registry.
...
| [Getting Started](docs/runbooks/getting-started.md) | First-time user guide |
| [CLAUDE.md](CLAUDE.md) | Context for Claude Code sessions |
| [AGENTS.md](AGENTS.md) | Registry of all 58 agents |
| [Constitution](docs/governance/JERRY_CONSTITUTION.md) | Framework governance and principles |
| [Problem-Solving Playbook](docs/playbooks/problem-solving.md) | Agent reference and keyword routing |
| [Orchestration Playbook](docs/playbooks/orchestration.md) | Multi-phase workflow guide |
