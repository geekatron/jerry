...
| 2026-02-22 | Claude | BUG-003 filed and resolved: PR #52 merge silently reverted EN-002 rule file changes (deprecated tokens= in L2-REINJECT markers, compound H-rule consolidations). Forensic diff identified 8+1 damaged files. eng-qa + eng-reviewer agents repaired all. S-014 adversary review confirmed. PR #74. |
