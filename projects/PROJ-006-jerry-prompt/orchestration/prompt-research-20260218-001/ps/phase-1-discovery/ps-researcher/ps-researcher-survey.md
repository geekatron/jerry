...
**Sources**: 5 distinct sources surveyed
**Status**: Complete
...
**Type**: Official vendor documentation
**Note**: Direct HTTP fetch was blocked (403); findings from this source are incorporated through cross-referenced content from DAIR.AI which extensively documents OpenAI's published guidance, and through principles consistent across all sources.

**Key principles documented by OpenAI (as referenced through DAIR.AI)**:
...
1. **No direct OpenAI documentation fetch**: The OpenAI guide at help.openai.com returned 403. The OpenAI principles cited are corroborated through DAIR.AI's documentation of their published guidance.
...
*Sources: 5 distinct sources (Anthropic Prompt Engineering Docs, Anthropic Agent Skills Best Practices, Anthropic Tool Use Docs, DAIR.AI Prompting Guide, OpenAI Prompt Engineering Guide)*
