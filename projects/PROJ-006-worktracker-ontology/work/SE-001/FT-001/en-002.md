...
|---|------|--------|----------|
| 1 | Research SAFe hierarchy levels | PENDING | |
| 2 | Research SAFe work item types | PENDING | |
| 3 | Research SAFe PI concepts | PENDING | |
...
|----------|----------|--------|
| Raw Research | `research/SAFE-RAW.md` | Not started |
| Domain Model | `analysis/SAFE-MODEL.md` | Not started |
