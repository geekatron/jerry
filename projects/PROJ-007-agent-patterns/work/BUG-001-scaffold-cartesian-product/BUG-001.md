...
| [Steps to Reproduce](#steps-to-reproduce) | Reproduction reference |
| [System Mapping](#system-mapping) | External system type mappings |
...
See [Reproduction Steps](#reproduction-steps) above.
