...
### Backlinks
- [TDD-transcript-skill.md](./docs/TDD-transcript-skill.md) - Architecture overview
- [ADR-001](../EN-004-architecture-decisions/docs/adrs/adr-001.md) - Agent Architecture
- [ADR-002](../EN-004-architecture-decisions/docs/adrs/adr-002.md) - Artifact Structure
- [TASK-008-skill-md.md](./TASK-008-skill-md.md) - Task definition

### Forward Links
- [PLAYBOOK-en005.md](./PLAYBOOK-en005.md) - Execution playbook
- [RUNBOOK-en005.md](./RUNBOOK-en005.md) - Operational procedures
...
- `agents/ts-parser/AGENT.md` - Parser agent definition
- `agents/ts-extractor/AGENT.md` - Extractor agent definition
- `agents/ts-formatter/AGENT.md` - Formatter agent definition
