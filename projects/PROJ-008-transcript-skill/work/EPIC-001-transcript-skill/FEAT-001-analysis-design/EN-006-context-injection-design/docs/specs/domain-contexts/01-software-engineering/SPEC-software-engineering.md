...
See [extraction/extraction-rules.yaml](./extraction/extraction-rules.yaml) for complete patterns.
...
See [prompts/prompt-templates.md](./prompts/prompt-templates.md) for the full template.
...
See [validation/acceptance-criteria.md](./validation/acceptance-criteria.md) for complete criteria.
...
|----------|--------------|
| [VCRM-domains.md](../VCRM-domains.md) | Verification matrix |
| [DOMAIN-SCHEMA.json](../DOMAIN-SCHEMA.json) | Validation schema |
| [SPEC-context-injection.md](../../../SPEC-context-injection.md) | Parent specification |
