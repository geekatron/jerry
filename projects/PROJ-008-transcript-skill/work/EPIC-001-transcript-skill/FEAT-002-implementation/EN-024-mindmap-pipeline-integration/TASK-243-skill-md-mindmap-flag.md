...
- [x] --no-mindmap opt-out flag documented in Input Parameters section
- [x] --mindmap-format parameter documented with allowed values
- [x] Default behavior clearly stated (mindmaps ON by default)
- [x] Slash command examples updated (show default and opt-out)
- [x] Natural language invocation examples updated
- [x] Pipeline diagram shows mindmap step as default (with opt-out path)
- [x] State passing updated for ts_mindmap_output
- [x] Output directory specified as `08-mindmap/` (per DISC-001)
...
| 2026-01-30 | **DONE** | **TASK COMPLETE**: SKILL.md v2.1.0 updated with all mindmap parameters. Commit: `8ac3e28`. All 8 acceptance criteria verified and met. Changes: Input Parameters table (+2 params), Available Agents table (+2 agents), Output Structure (08-mindmap/), Orchestration Flow (STEP 3.5), State Schema (ts_mindmap_output), Pipeline diagram (conditional mindmap step), version bump to 2.1.0. |
