...
**Description:** Rename current repository to `source-repository` (internal), create new public `jerry` repository.
...
jerry/
├── packages/
│   ├── source-repository/           # Core framework
...
@import projects/PROJ-009-oss-release/CONTEXT.md
```
