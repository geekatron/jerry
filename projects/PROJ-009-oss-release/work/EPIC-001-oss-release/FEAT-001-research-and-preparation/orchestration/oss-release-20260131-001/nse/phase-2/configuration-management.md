...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  source-repository (INTERNAL)                 jerry (PUBLIC)                       │
│  ─────────────────────                 ─────────────                        │
│                                                                             │
│  ┌─────────────────────┐              ┌─────────────────────┐               │
...
│  └─────────────────────┘              └─────────────────────┘               │
│                                                                             │
│  VERSION ALIGNMENT: jerry v0.3.0 ←─── SYNCED FROM ───→ source-repository v0.3.0   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│  2. External contributions to jerry are backported to source-repository           │
│  3. Feature branches ONLY exist in source-repository                              │
...
| Pre-release | `vX.Y.Z-rcN` | `v0.3.0-rc1` | source-repository only | Internal testing |
| Sync-point | `sync-vX.Y.Z-YYYYMMDD` | `sync-v0.3.0-20260201` | source-repository only | Audit trail |
...
|-----------|-------------|-------------|
| INV-001 | `jerry:tag` ALWAYS equals `source-repository:tag` for same version | Sync workflow |
| INV-002 | `jerry:main` ALWAYS lags or equals `source-repository:main` | Sync direction |
...
│  4. FIX:                                                                    │
│     ├── Hotfix branch in source-repository                                         │
...
*This document was produced by nse-config agent as part of Phase 2 Tier 4 for PROJ-009-oss-release.*
