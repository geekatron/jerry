# Design Baseline: PROJ-009 OSS Release
...
This document establishes the Design Baseline for the PROJ-009 OSS Release per NPR 7123.1D Section 5.4 Configuration Management requirements. The baseline captures:
