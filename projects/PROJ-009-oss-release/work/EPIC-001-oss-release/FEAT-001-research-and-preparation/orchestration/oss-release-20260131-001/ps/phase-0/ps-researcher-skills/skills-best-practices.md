...
```yaml
researcher_output:
  ps_id: "PROJ-009-oss-release"
  entry_id: "EN-005"
  artifact_path: "projects/PROJ-009-oss-release/work/EPIC-001-oss-release/FEAT-001-research-and-preparation/orchestration/oss-release-20260131-001/ps/phase-0/ps-researcher-skills/skills-best-practices.md"
