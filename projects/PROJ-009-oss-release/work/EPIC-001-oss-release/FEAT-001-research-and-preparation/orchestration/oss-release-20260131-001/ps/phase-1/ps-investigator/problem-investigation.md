...
> **Entry:** PROJ-009-ORCH-P1-INV-001
...
**Source 2: Quality Review Results (internal-sample)**
...
| Field | Value |
|-------|-------|
| **Document ID** | PROJ-009-ORCH-P1-INV-001 |
| **Status** | COMPLETE |
...
*Document generated by ps-investigator agent for PROJ-009-oss-release orchestration workflow.*
