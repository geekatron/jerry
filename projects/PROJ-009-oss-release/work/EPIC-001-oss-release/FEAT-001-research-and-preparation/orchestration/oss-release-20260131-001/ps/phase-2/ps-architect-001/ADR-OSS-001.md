...
├── architecture-standards.md (existing - ~500 lines)
├── coding-standards.md (existing - ~400 lines)
├── testing-standards.md (existing - ~400 lines)
├── python-environment.md (existing - ~100 lines)
└── file-organization.md (existing - ~300 lines)

TIER 3: skills/ (on-demand)
├── worktracker/SKILL.md      ← Full entity mappings, templates, behavior
├── problem-solving/SKILL.md  ← PS frameworks (existing)
├── orchestration/SKILL.md    ← Multi-agent coordination (existing)
├── transcript/SKILL.md       ← Transcription workflows (existing)
└── ...
...
*This ADR was produced by ps-architect-001 for PROJ-009-oss-release Phase 2.*
