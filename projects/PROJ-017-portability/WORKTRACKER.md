...
| ID | Title | Severity | Platform | GitHub | Status |
|----|-------|----------|----------|--------|--------|
| BUG-017-001 | statusLine uses python3 | Major | Windows | [#113](https://github.com/geekatron/jerry/issues/113) | Open |
| BUG-017-002 | Migration scripts bash-only | Major | Windows | [#114](https://github.com/geekatron/jerry/issues/114) | Open |
