...
| EPIC-003 | Epic | CI Pipeline Optimization — Remove Pip Matrix, Fix Supply Chain Gaps, Consolidate Jobs | pending | PROJ-024 |
| TASK-016 | Task | Remove pip test matrix (8 jobs) | pending | EPIC-003 |
| TASK-017 | Task | Migrate lint, type-check, security to uv | pending | EPIC-003 |
| TASK-018 | Task | Fix pip-audit to scan full dependency tree | pending | EPIC-003 |
| TASK-019 | Task | Consolidate 6 validation jobs into 1 | pending | EPIC-003 |
| TASK-020 | Task | Merge lint + type-check into static-analysis | pending | EPIC-003 |
| TASK-021 | Task | Scope pull-requests:write to coverage-report only | pending | EPIC-003 |
| TASK-022 | Task | Restrict push trigger to protected branches only | pending | EPIC-003 |
