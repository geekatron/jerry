...
| 2026-08-12 | in_progress | Formal re-scores against the final commits: 0.928 (`e00ed1c4`) -> 0.917 REVISE (`18ce85de`: `main.py` router still leaked two diagnostics to stdout + #371 status was stale in three docs) -> **0.9335 PASS** (`888c94a8`: completed the #371 stderr sweep across the `jerry ast` router, reconciled #371 status in all artifacts, dispositioned RT-004/RT-005). All six dimensions >= 0.91. Ready for PR #341 review/merge (`Closes #337`, `Closes #371`). |
