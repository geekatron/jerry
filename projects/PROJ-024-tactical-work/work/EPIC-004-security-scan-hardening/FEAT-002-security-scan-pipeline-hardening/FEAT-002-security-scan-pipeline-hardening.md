...
| BUG-009 | Bug | click 8.3.1 transitive command injection in click.edit() — PYSEC-2026-2132 (GH #336) | completed (2026-08-05) | high | — |
...
| **Total Bugs** | 2 |
| **Completed Bugs** | 2 (BUG-008, BUG-009 — both closed 2026-08-05) |
| **Open Bugs** | 0 |
| **Total Tasks** | 1 |
| **Completed Tasks** | 0 |
