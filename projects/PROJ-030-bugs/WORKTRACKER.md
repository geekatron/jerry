...
| TASK-003 | Task | Remove deprecated pre_tool_use.py — verify CLI enforcement pipeline (#177) | in_progress | EN-001 |
| TASK-004 | Task | Claude Code permission syntax reference (#179) | in_progress | PROJ-030-bugs |
| TASK-006 | Task | Consolidate dual SubagentStop hooks (#178) | pending | EN-001 |
