...
| BUG-006 | Bug | Agent output paths hardcoded to skill directories (#230) | open | PROJ-030-bugs |
| TASK-006 | Task | eng-team path remediation (22 config files) | open | BUG-006 |
| TASK-007 | Task | red-team path remediation (25 config files) | open | BUG-006 |
| TASK-008 | Task | UX skills path remediation — 11 sub-skills (60 files) | open | BUG-006 |
| TASK-009 | Task | Remove committed eng-team/output/ (28 files, 600K) | open | BUG-006 |
| TASK-010 | Task | Add output path MEDIUM standard to agent-development-standards.md | open | BUG-006 |
| TASK-011 | Task | Update .gitignore to prevent skills/*/output/ accumulation | open | BUG-006 |
| TASK-012 | Task | Fix diataxis SKILL.md plural/singular naming inconsistencies | open | BUG-006 |
| BUG-007 | Bug | tspec-generator silently skips unrecognized extensions (#195) | open | PROJ-030-bugs |
| BUG-008 | Bug | tspec-analyst uses live UC as coverage denominator (#197) | open | PROJ-030-bugs |
| BUG-009 | Bug | tspec-analyst has no cross-slice aggregate coverage (#196) | open | PROJ-030-bugs |
| BUG-010 | Bug | uc-slicer lacks duplicate slice_id conflict detection (#199) | open | PROJ-030-bugs |
| BUG-011 | Bug | cd-generator banned-term false positives under 60 chars (#198) | open | PROJ-030-bugs |
