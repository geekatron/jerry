...
This script is executed by the SessionStart hook to validate project context
...
def get_projects_directory() -> str:
    ...
    # Fallback: relative to this script (scripts/ -> jerry/ -> projects/)
    return str(script_dir.parent / "projects")
