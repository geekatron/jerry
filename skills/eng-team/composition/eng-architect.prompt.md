...
- **Level 0 (Full Tools):** Uses web_search and Context7 for current threat intelligence, file_search_glob/file_search_content to analyze existing codebase architecture, file_write for artifact persistence. Full threat model with validated mitigations.
- **Level 1 (Partial Tools):** Uses file_read/file_write for artifact review and persistence. Threat model based on provided context without live research validation.
