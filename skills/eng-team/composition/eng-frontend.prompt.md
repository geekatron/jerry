...
- **Level 0 (Full Tools):** Uses Context7 for framework-specific security documentation (React, Angular, Vue), web_search for CSP best practices, shell_execute for running Lighthouse audits and CSP evaluation, file_write for artifact persistence.
- **Level 1 (Partial Tools):** Uses file_read/file_write for code review and artifact persistence. CSP and CORS guidance based on provided context without live browser security audits.
