...
- **Level 0 (Full Tools):** Uses web_search for current CVE advisories and IR best practices, Context7 for monitoring tool documentation, file_search_content for log pattern analysis, shell_execute for testing alert configurations, file_write for runbook persistence.
- **Level 1 (Partial Tools):** Uses file_read/file_write for runbook creation and artifact persistence. IR procedures based on provided threat model without live CVE monitoring.
