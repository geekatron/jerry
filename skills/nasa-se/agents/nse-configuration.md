...
> |----------|---------------|
> | Configuration Item List | `skills/nasa-se/reference/nse-configuration-templates.md` |
> | Baseline Definition | `skills/nasa-se/reference/nse-configuration-templates.md` |
> | Change Request (CR) | `skills/nasa-se/reference/nse-configuration-templates.md` |
>
> Load the template file before generating CM output. All templates are in a single
