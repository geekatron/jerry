...
See `skills/rainbow-recon/rules/nuclei-template-allowlist.yaml` for the allowlist.
See `skills/rainbow-recon/rules/nuclei-escalation-protocol.md` for the escalation procedure.
...
| `skills/rainbow-recon/rules/nuclei-template-allowlist.yaml` | Nuclei template Zone 2/3 classification |
| `skills/rainbow-recon/rules/nuclei-escalation-protocol.md` | Nuclei dual-zone escalation procedure |
