...
The authoritative zone classification for mitmproxy and Frida operations is defined in `skills/rainbow-runtime/rules/runtime-interception-protocol.md`. This protocol provides:
...
| `skills/rainbow-runtime/rules/runtime-interception-protocol.md` | Dual-zone classification authority |
