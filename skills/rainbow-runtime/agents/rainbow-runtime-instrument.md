...
This protocol matches the evidence integrity pattern established by rainbow-exploit agents. See `skills/rainbow-exploit/rules/exploit-engagement-protocol.md` for the shared evidence specification.
