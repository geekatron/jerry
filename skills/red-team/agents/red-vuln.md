...
name: red-vuln
version: "1.0.0"
description: "Vulnerability Analyst for /red-team. Performs vulnerability identification, CVE research, exploit availability assessment, attack path analysis, and risk scoring. Consumes reconnaissance findings from red-recon and produces prioritized vulnerability reports for red-exploit. Operates within analysis scope with read-only target interaction."
model: sonnet
