...
See [contexts/product-management.yaml](../../contexts/product-management.yaml) for the complete schema.
...
| [contexts/product-management.yaml](../../contexts/product-management.yaml) | Implementation schema |
