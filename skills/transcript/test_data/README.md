...
│   │   └── k8-network-policies-sample.vtt
...
│   ├── k8-network-policies-sample.expected.json
...
|------|--------|------|----------|---------|
| `transcripts/real/k8-network-policies-sample.vtt` | User VTT (first 20 cues) | 20 | 2 (Adam Nowak, Brendan Bennett) | VTT parsing verification |
...
| File | Source | Purpose |
|------|--------|---------|
| `expected/k8-network-policies-sample.expected.json` | Derived from VTT (deterministic) | Golden output for comparison |
...
|---------|------|-------|----------|
| vtt-001 | Voice tags with closing tags | k8-network-policies-sample.vtt | FR-001.3 |
| vtt-002 | Multi-line cue payloads | k8-network-policies-sample.vtt | FR-001.4 |
| vtt-003 | Timestamp normalization | k8-network-policies-sample.vtt | NFR-006 |
| vtt-004 | Speaker extraction | k8-network-policies-sample.vtt | FR-001.3 |
| vtt-005 | Canonical JSON schema | k8-network-policies-sample.vtt | TDD Section 3 |
...
1. **k8-network-policies-sample.expected.json**
...
2. Run ts-parser against `transcripts/real/k8-network-policies-sample.vtt`
3. Compare output against `expected/k8-network-policies-sample.expected.json`
