...
"""
Coverage - Code coverage percentage value object.

Represents code coverage as a validated percentage with comparison
and threshold checking capabilities.

Note: Renamed from TestCoverage to Coverage to avoid pytest collection
...
class Coverage:
    ...
    @classmethod
    def from_percent(cls, value: float) -> Coverage:
        """
        ...
        Example:
            >>> Coverage.from_percent(85.567)
            Coverage(percent=85.57)
        """
    ...
    @classmethod
    def from_fraction(cls, covered: int, total: int) -> Coverage:
        """
        ...
        Returns:
            New Coverage instance (0% if total is 0)
    ...
    def __repr__(self) -> str:
        ...
        return f"Coverage(percent={self.percent})"
